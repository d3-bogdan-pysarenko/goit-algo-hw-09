...
Жадібні алгоритми зазвичай швидші у виконанні та імплементації, але при  цьому вони не дають гарантії найбільш оптимального результату виконання завдання, що проілюстровано у їх порівнянні для другого набору абстрактних монет.

При цьому часова складність **Жадібних алгоритмів** = `O(n)` де `n` = кількість номіналів монет,  в той час як часова складність **Функцій динамічного програмування** = `O(n × m)` де `n` = кількість номіналів монет, а `m` = шукана сума.

Враховуючи вказане, **Жадібні алгоритми** будуть швидше працювати для великих сум, але при цьому не завжди гарантуватимуть оптимальний результат, в той час як **Функції динамічного програмування** завжди будуть видавати оптимальницй результат, однак працюватимуть повільніше, особливо для підрахунків великих значень.
